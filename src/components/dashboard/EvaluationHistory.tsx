...
const MOCK_DATA: Evaluation[] = [\
  \{\
    ...
    detalhes: \{\
      ...
      'Organiza\'e7\'e3o e Limpeza': '9,00',\
      'Proatividade': '8,00'\
    \}\
  \},\
  \{\
    ...
    detalhes: \{\
      ...
      'Comunica\'e7\'e3o Clara': '9,00',\
      'Relacionamento': '9,00',\
      'Tomada de Decis\'e3o': '9,00'\
    \}\
  \},\
  \{\
    id: '8202b0b3',\
    funcionario: 'JO\'c3O SILVA',\
    cargo: 'Financeiro',\
    setor: 'Financeiro',\
    tipo: 'Colaborador',\
    data: '2025-09-01',\
    notaFinal: '7,50',\
<<<<<<< HEAD:src/components/dashboard/EvaluationHistory.tsx.rtf
    detalhes:}
=======
    detalhes: \{\
      ...
      <div className="flex items-center justify-between mb-6 border-b pb-4">\
        <div className="flex items-center gap-2">\
          ...
          <h2 className="text-xl font-bold text-gray-800">\
            \{viewLevel === 1 && "Hist\'f3rico de Avalia\'e7\'f5es"\}\
            \{viewLevel === 2 && `Avalia\'e7\'f5es de $\{selectedPeriod\}`\}\
          ...
          <table className="w-full text-left border-collapse">\
            <thead>\
              <tr className="bg-gray-50 text-gray-600 text-sm uppercase tracking-wider">\
                <th className="p-4 rounded-tl-lg">Per\'edodo</th>\
                <th className="p-4">Total de Avalia\'e7\'f5es</th>\
                <th className="p-4">M\'e9dia Geral</th>\
                <th className="p-4 rounded-tr-lg text-right">A\'e7\'e3o</th>\
              </tr>\
            </thead>\
                ...
                >\
                  ...
                  <td className="p-4">\
                    <span className=\{`text-xs px-2 py-1 rounded border $\{\
                      evaluation.tipo === 'L\'edder' ? 'border-purple-200 text-purple-700 bg-purple-50' : 'border-gray-200 text-gray-600'\
                    \}`\}>\
                      \{evaluation.tipo\}\
                    </span>\
                  </td>\
          ...
          <div className="border rounded-lg overflow-hidden">\
            <table className="w-full text-left">\
              <thead className="bg-gray-100">\
                <tr>\
                  <th className="p-3 text-sm font-semibold text-gray-600">Crit\'e9rio Avaliado</th>\
                  <th className="p-3 text-sm font-semibold text-gray-600 text-right">Nota / Avalia\'e7\'e3o</th>\
                </tr>\
              </thead>\
              <tbody className="divide-y divide-gray-100">\
...
\};}
>>>>>>> 63a44a78b35e30952072f69f00757d2891d16901:src/components/dashboard/EvaluationHistory.tsx
