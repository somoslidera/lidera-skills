 ...
 * 
 * Execute este script com: node scripts/create-admin-user.js
 * 
 * IMPORTANTE: Você precisa ter as variáveis de ambiente configuradas ou
 * modificar os valores hardcoded abaixo com suas credenciais do Firebase.
 */
